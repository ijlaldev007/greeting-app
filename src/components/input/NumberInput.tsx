    ...
    <div className='w-full max-w-[400px] md:max-w-[450px] lg:max-w-[500px] relative space-y-1'>
      ...
      <div className='relative flex items-center h-[51px] rounded-[30px]  bg-white focus-within:ring-2 focus-within:ring-primary transition-all px-4'>
        ...
        >
          ...
          <span className='typography-label'>+{countryCallingCode}</span>
          <FaChevronDown className='text-heading text-sm ml-1' />
        </button>
        ...
        <input
          ...
          maxLength={11}
          className='flex-1 h-full outline-none font-montserrat text-base text-heading placeholder:typography-placeholder bg-transparent border-none'
        />
      </div>
          ...
          {countries.map((country) => (
            ...
            >
              <img
                ...
                className='w-5 h-5'
              />
              <span className='typography-greeting-item'>
                {country.name.common} (+
